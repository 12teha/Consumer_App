...
export default function ProfileScreen({
  ...
  const handleLogout = () => {
    ...
    // Clear authentication session
    authService.clearAuth();
    // Navigate directly to PhoneEntryScreen
    onNavigate("phone");
  };
    ...
    <div className="h-screen bg-gray-50 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="mt-4 mx-4 mb-6 space-y-3"
        >
          {/* Logout Button */}
          <AlertDialog
          ...
          >
            <AlertDialogTrigger asChild>
              <Button
                variant="outline"
                className="w-full flex items-center justify-center space-x-2 text-red-600 border-red-200 hover:bg-red-50 cursor-pointer"
              >
                <LogOut className="w-5 h-5" />
                <span>Logout</span>
              </Button>
          ...
          >
            <AlertDialogTrigger asChild>
              <Button
                variant="outline"
                className="w-full flex items-center justify-center space-x-2 text-gray-600 border-gray-200 hover:bg-gray-50 hover:text-red-600 hover:border-red-200 transition-colors"
              >
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription className="text-gray-600">
                  ...
                  your OfferBeez account and remove all your data including:
                  <br />
                  <br />
                  • Your profile information
                  <br />
                  • Liked offers and preferences
                  <br />
                  • Location data
                  <br />
